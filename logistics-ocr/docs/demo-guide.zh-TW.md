...
![UC12 Step Functions 圖表視圖 (SUCCEEDED)](../../docs/screenshots/masked/uc12-demo/step-functions-graph-succeeded.png)

![UC12 Step Functions 圖表 (縮放 — 各步驟詳細)](../../docs/screenshots/masked/uc12-demo/step-functions-graph-zoomed.png)
