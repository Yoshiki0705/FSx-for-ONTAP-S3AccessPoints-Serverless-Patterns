...
![UC12 Vue graphique Step Functions (SUCCEEDED)](../../docs/screenshots/masked/uc12-demo/step-functions-graph-succeeded.png)

![UC12 Graphique Step Functions (zoom — détail par étape)](../../docs/screenshots/masked/uc12-demo/step-functions-graph-zoomed.png)
