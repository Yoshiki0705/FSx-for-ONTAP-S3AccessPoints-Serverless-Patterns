# 人材・HR — 履歴書スクリーニング / PII 厳格モード Demo Guide
...
| 項目 | 詳細 |
|------|------|
| **役職** | 人事部 採用マネージャー / タレントアクイジション担当 |
| **日常業務** | 応募書類の受理・スクリーニング、候補者評価、面接調整 |
| **課題** | 大量の履歴書・職務経歴書の手動スクリーニング、バイアスの排除 |
| **期待する成果** | 応募書類の自動スクリーニングと候補者スコアリング |
...
cd fsxn-s3ap-serverless-patterns/hr-document-screening
```
...
aws cloudformation wait stack-delete-complete --stack-name fsxn-hr-screening-demo --region ap-northeast-1
```
