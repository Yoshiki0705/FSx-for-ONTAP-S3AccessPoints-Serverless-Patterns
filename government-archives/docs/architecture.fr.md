...
```mermaid
graph LR
    FSx[FSx for ONTAP<br/>Stockage documents publics<br/>ACL NTFS par département] --> S3AP[S3 Access Point]
...
- Conformité WORM possible avec FSx for ONTAP Snapshot + Backup
