...
```mermaid
graph LR
    FSx[FSx for ONTAP<br/>Public Records Storage<br/>Department-level NTFS ACL] --> S3AP[S3 Access Point]
...
- WORM compliance available via FSx for ONTAP Snapshot + Backup
