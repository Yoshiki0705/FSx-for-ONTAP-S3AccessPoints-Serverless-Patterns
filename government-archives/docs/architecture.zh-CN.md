...
利用 FSx for ONTAP S3 Access Points 实现公文档（PDF / TIFF / EML / DOCX）的
...
| `FSXN_S3AP` | FSx for ONTAP S3 Access Point | 无（写回现有 FSx 卷） | 公文档负责人通过 SMB/NFS 在与原始文档相同的目录中查看 OCR 文本、编辑后文件、元数据 |
