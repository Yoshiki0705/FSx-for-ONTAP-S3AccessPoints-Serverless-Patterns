...
![UC10 Step Functions Graph-Ansicht (SUCCEEDED)](../../docs/screenshots/masked/uc10-demo/step-functions-graph-succeeded.png)

![UC10 Step Functions Graph (gezoomt — Schrittdetails)](../../docs/screenshots/masked/uc10-demo/step-functions-graph-zoomed.png)
