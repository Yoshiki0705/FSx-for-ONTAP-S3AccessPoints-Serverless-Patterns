...
![UC10 Step Functions 그래프 뷰 (SUCCEEDED)](../../docs/screenshots/masked/uc10-demo/step-functions-graph-succeeded.png)

![UC10 Step Functions 그래프 (확대 — 단계별 상세)](../../docs/screenshots/masked/uc10-demo/step-functions-graph-zoomed.png)
