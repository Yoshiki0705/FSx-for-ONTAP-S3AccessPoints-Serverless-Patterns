...
**Date**: 2026-05-13
**Environment**: Account `123456789012`, Region `ap-northeast-1`
...
| `fsxn-eda-deploy-123456789012` bucket | Deploy bucket for Lambda packages, always needed |
| `fsxn-s3ap-guard-rules-123456789012` bucket | Guard Hooks rules bucket |
