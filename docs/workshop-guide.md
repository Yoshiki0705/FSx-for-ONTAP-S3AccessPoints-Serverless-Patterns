# Partner Workshop Guide — 導入先向け PoC ワークショップ

🌐 **Language / 言語**: 日本語 | [English](workshop-guide.en.md)

## 概要

パートナー/SI が導入先向けに実施する 1 日ワークショップのガイドです。
...
| 14:30-14:45 | 休憩 | — | — |
| 14:45-15:45 | Session 4 | セキュリティ・ガバナンスレビュー | パートナー + 導入先 |
...
ワークショップ実施 1 週間前に、導入先の参加者に以下の情報を準備いただくよう依頼してください:
