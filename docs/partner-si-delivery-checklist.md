...
🌐 **Language / 言語**: 日本語 | [English](partner-si-delivery-checklist.en.md)
...
| Self-Service KB / GenAI ops | UC29 Self-Service KB Curation | "Do you want business users to maintain the AI knowledge base themselves via Windows drag & drop?" | "Who currently performs the manual copy/ingestion of files into your Knowledge Base, and how long is the update lead time?" |
| Agentic workspace / GenAI + BI | UC30 Amazon Quick Agentic Workspace | "Do you want one agentic workspace that searches files, analyzes structured data, and takes actions over your enterprise data?" | "Which roles need to combine document search, BI dashboards, and automated actions, and where does that data live today?" |
