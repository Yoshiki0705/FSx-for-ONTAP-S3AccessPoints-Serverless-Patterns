...
| シナリオ | 対応 UC | 期待効果 |
|---------|---------|---------|
| 公文書アーカイブの自動分類・検索 | UC16 | 情報公開請求対応時間の短縮 |
| 監査資料の自動整理・メタデータ付与 | UC1 | 監査準備工数の削減 |
| 防災・都市計画データの地理空間分析 | UC17 | 災害リスク評価の迅速化 |

#### 教育機関
| シナリオ | 対応 UC | 期待効果 |
|---------|---------|---------|
| 校務文書の自動分類・保管期限管理 | UC1, UC16 | 教職員の事務負荷軽減 |
| 教材・学習データの整理・検索性向上 | UC13 | 教材再利用率の向上 |
| 教育データ分析レポートの自動生成 | UC13 | データに基づく教育改善 |

#### 医療機関
| シナリオ | 対応 UC | 期待効果 |
|---------|---------|---------|
| DICOM 画像の自動分類・メタデータ整理 | UC5 | 放射線科の検索効率向上 |
| 退院サマリー・診療記録の要約支援 | UC2 | 医師の文書作成負荷軽減 |
| 研究データの分類・匿名化レビュー | UC7, UC5 | 研究データ利活用の促進 |
