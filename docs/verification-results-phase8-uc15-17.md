...
**S3 Output**:
- `fsxn-autonomous-driving-demo-output-123456789012` バケットに出力確認
...
```
User: arn:aws:sts::123456789012:assumed-role/fsxn-genomics-pipeline-demo-discovery-role/
fsxn-genomics-pipeline-demo-discovery is not authorized to perform:
s3:PutObject on resource: "arn:aws:s3:ap-northeast-1:123456789012:accesspoint/
