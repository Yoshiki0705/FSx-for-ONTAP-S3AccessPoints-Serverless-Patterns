...
> **データ鮮度**: Transfer Family の FSx for ONTAP S3 AP 対応は 2026/1 GA [5][6][7]。Nextcloud External Storage の S3 互換性は Nextcloud 29 で検証済み。ownCloud OCIS の multi-storage は OCIS 5.x ドキュメント参照。
