# CDN / 엣지 배포 통합 비교 — FSx ONTAP S3 Access Points에서의 배포
...
마케팅적 주장을 **다루지 않습니다**. 다루는 것은 FSx ONTAP S3 AP의 제약에 대해 **무엇이 실현 가능하고,
...
> FSx ONTAP S3 AP accesspoint alias에서의 동작은 TBV.
...
- **검증 필요(본 프로젝트)**: FSx ONTAP S3 AP accesspoint alias에 대한 각 CDN의 SigV4 오리진 서명 실동작.
