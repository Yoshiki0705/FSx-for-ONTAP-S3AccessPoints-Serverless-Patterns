...
```json
{
  ...
  "Resource": "arn:aws:s3:ap-northeast-1:123456789012:accesspoint/fsxn-eda-s3ap"
}
{
  "Effect": "Allow",
  "Action": ["s3:GetObject"],
  "Resource": "arn:aws:s3:ap-northeast-1:123456789012:accesspoint/fsxn-eda-s3ap/object/*"
}
```
