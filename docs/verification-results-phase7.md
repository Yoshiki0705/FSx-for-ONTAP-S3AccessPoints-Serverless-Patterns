...
```
ExecutionArn: arn:aws:states:ap-northeast-1:123456789012:execution:fsxn-uc15-demo-workflow:<uuid>
Status: SUCCEEDED
```
...
S3 バケット `fsxn-uc15-demo-output-123456789012`:
...
```
ExecutionArn: arn:aws:states:ap-northeast-1:123456789012:execution:fsxn-uc16-demo-workflow:<uuid>
Status: SUCCEEDED
```
...
S3 バケット `fsxn-uc16-demo-output-123456789012`:
...
```
ExecutionArn: arn:aws:states:ap-northeast-1:123456789012:execution:fsxn-uc17-demo-workflow:<uuid>
Status: SUCCEEDED
```
...
S3 バケット `fsxn-uc17-demo-output-123456789012`:
