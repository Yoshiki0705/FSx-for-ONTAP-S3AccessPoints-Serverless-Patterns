...
|------|-------------------|-----------------|
| Account ID | 178625946981 | 351389403887 |
| Account Name | yoshiki (management) | fsxn-cross-account-test |
| Region | ap-northeast-1 | ap-northeast-1 |
| OAM Role | Sink | Link |
| Sink ARN | arn:aws:oam:ap-northeast-1:178625946981:sink/8ec487e1-b441-4c98-a53e-cf7fdf9604ff | — |
| Link ARN | — | arn:aws:oam:ap-northeast-1:351389403887:link/9ffe53e9-d8a7-4710-8286-7c3460d3a719 |
...
aws sts assume-role --role-arn arn:aws:iam::351389403887:role/OrganizationAccountAccessRole ...
...
|---|------|-----------------|---------------|:---:|
| 1 | Create OAM Sink in management account | Sink created | ✅ Sink ID: 8ec487e1-... | ✅ |
...
| 4 | Create OAM Link in workload account | Link created | ✅ Link ID: 9ffe53e9-... | ✅ |
| 5 | Verify Link visible from management account | Link appears in list | ✅ Label: fsxn-cross-account-test | ✅ |
