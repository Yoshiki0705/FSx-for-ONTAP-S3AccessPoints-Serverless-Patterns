...
🌐 **Language / 言語**: [日本語](fpolicy-setup-guide.md) | [English](fpolicy-setup-guide-en.md) | [한국어](fpolicy-setup-guide-ko.md) | [简体中文](fpolicy-setup-guide-zh-CN.md) | 繁體中文 | [Français](fpolicy-setup-guide-fr.md) | [Deutsch](fpolicy-setup-guide-de.md) | [Español](fpolicy-setup-guide-es.md)
...
> ⚠️ **重要：使用 vers=4.1 或 vers=3 掛載。不要使用 vers=4（會協商為 NFSv4.2，FPolicy 不支援）。**
