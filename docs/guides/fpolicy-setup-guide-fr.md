...
> ⚠️ **IMPORTANT : Montez avec vers=4.1 ou vers=3. Ne pas utiliser vers=4 (négocie en NFSv4.2 non supporté par FPolicy).**
...
## Configuration SMB (CIFS) (Active Directory requis)
