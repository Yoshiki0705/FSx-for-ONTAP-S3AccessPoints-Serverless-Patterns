...
| メトリクス | 測定方法 |
|-----------|--------|
| ログファイル処理件数 / 実行 | CloudWatch Metrics / Step Functions 実行結果 |
| 異常検知の精度（偽陽性率） | CloudWatch Metrics / Step Functions 実行結果 |
| 品質検査画像の分析スループット | CloudWatch Metrics / Step Functions 実行結果 |
| 検査レポート生成時間 | CloudWatch Metrics / Step Functions 実行結果 |
| スキャンあたりのコスト | CloudWatch Metrics / Step Functions 実行結果 |
