...
![UC3 Step Functions 圖表視圖 (SUCCEEDED)](../../docs/screenshots/masked/uc3-demo/step-functions-graph-succeeded.png)

![UC3 Step Functions 圖表 (展開檢視)](../../docs/screenshots/masked/uc3-demo/step-functions-graph-expanded.png)

![UC3 Step Functions 圖表 (縮放 — 各步驟詳細)](../../docs/screenshots/masked/uc3-demo/step-functions-graph-zoomed.png)
