...
FSx ONTAP S3 Access Point 経由の ListObjectsV2 / GetObject のレイテンシを測定する。
...
注意:
  ...
  - FSx ONTAP スループットは NFS/SMB/S3AP 共有。実行時の同時ワークロード有無を併記すること。
...
def run(args: argparse.Namespace) -> dict:
    ...
    return {
        ...
        "caveats": [
            ...
            "FSx ONTAP スループットは NFS/SMB/S3AP 共有。同時ワークロードの有無を併記。",
