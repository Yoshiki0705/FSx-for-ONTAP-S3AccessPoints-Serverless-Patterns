...
![UC5 Step Functions 图表视图 (SUCCEEDED)](../../docs/screenshots/masked/uc5-demo/step-functions-graph-succeeded.png)

![UC5 Step Functions 图表 (缩放 — 各步骤详细)](../../docs/screenshots/masked/uc5-demo/step-functions-graph-zoomed.png)
