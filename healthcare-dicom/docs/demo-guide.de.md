...
![UC5 Step Functions Graph-Ansicht (SUCCEEDED)](../../docs/screenshots/masked/uc5-demo/step-functions-graph-succeeded.png)

![UC5 Step Functions Graph (gezoomt — Schrittdetails)](../../docs/screenshots/masked/uc5-demo/step-functions-graph-zoomed.png)
