...
![UC5 Vista de gráfico Step Functions (SUCCEEDED)](../../docs/screenshots/masked/uc5-demo/step-functions-graph-succeeded.png)

![UC5 Gráfico Step Functions (ampliado — detalle por paso)](../../docs/screenshots/masked/uc5-demo/step-functions-graph-zoomed.png)

### Pantallas UI/UX objetivo para re-verificación (lista de capturas recomendadas)

- Bucket S3 de salida (dicom-metadata/, deid-reports/, diagnoses/)
- Resultados de detección de entidades Comprehend Medical (Cross-Region)
- JSON de metadatos DICOM desidentificados
