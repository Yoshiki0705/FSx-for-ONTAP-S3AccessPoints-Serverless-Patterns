...
- Textract OCR results JSON (fields extracted from contracts/invoices)
- Comprehend entity detection results (organizations, dates, amounts)
- Bedrock-generated summary report
