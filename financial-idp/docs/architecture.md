...
│  • ListObjectsV2 (ドキュメント検出)                                          │
│  • GetObject (PDF/TIFF/JPEG 取得)                                            │
...
│  │             │    │                      │    │               │          │
│  │  • VPC内     │    │  • Textract 同期/非同│    │  • Comprehend  │          │
│  │  • S3 AP List│    │    期 API 自動選択   │    │  • Named Entity│          │
│  │  • PDF/TIFF  │    │  • テキスト抽出      │    │  • 日付/金額等 │          │
│  └─────────────┘    └──────────────────────┘    └───────┬────────┘          │
│                                                          │                   │
│                                                          ▼                   │
│                                                 ┌────────────────┐          │
...
│  ├── ocr-text/YYYY/MM/DD/                                                    │
│  │   ├── 保険契約_2024-001.txt       ← OCR 抽出テキスト                     │
│  │   └── invoice_20240315.txt                                                │
│  ├── entities/YYYY/MM/DD/                                                    │
│  │   ├── 保険契約_2024-001.json      ← 抽出エンティティ                     │
│  │   └── invoice_20240315.json                                               │
│  └── summaries/YYYY/MM/DD/                                                   │
│      ├── 保険契約_2024-001_summary.json  ← 構造化サマリー                   │
