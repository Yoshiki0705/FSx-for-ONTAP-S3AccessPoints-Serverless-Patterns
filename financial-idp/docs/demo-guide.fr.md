...
![UC2 Vue graphique Step Functions (SUCCEEDED)](../../docs/screenshots/masked/uc2-demo/step-functions-graph-succeeded.png)

### Écrans UI/UX cibles pour re-vérification (liste de captures recommandées)

- Bucket S3 de sortie (textract-results/, comprehend-entities/, reports/)
- Résultats JSON Textract OCR (champs extraits de contrats/factures)
- Résultats de détection d'entités Comprehend (organisations, dates, montants)
