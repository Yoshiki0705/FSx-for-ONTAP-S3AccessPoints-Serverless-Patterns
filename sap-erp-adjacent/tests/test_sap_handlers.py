...
def _load_handler(function_name: str):
    ...
    spec = importlib.util.spec_from_file_location(
        f"sap_{function_name}_handler", handler_path
    )
...
class TestDiscovery:
    ...
    def test_discovery_categorizes_idoc(self):
        ...
        mock_response = {
            "Contents": [
                {"Key": "idoc-export/ORDERS_20260520.idoc", "Size": 4096,
                 "LastModified": MagicMock(isoformat=lambda: "2026-05-20T00:00:00")},
                {"Key": "idoc-export/INVOIC_20260520.txt", "Size": 2048,
                 "LastModified": MagicMock(isoformat=lambda: "2026-05-20T00:00:00")},
            ],
            "IsTruncated": False,
        }
    ...
    def test_discovery_categorizes_edi(self):
        ...
        mock_response = {
            "Contents": [
                {"Key": "edi-inbound/PO_850.x12", "Size": 1024,
                 "LastModified": MagicMock(isoformat=lambda: "2026-05-20T00:00:00")},
            ],
            "IsTruncated": False,
        }
    ...
    def test_discovery_categorizes_hulft(self):
        ...
        mock_response = {
            "Contents": [
                {"Key": "hulft-landing/hulft_transfer_001.csv", "Size": 8192,
                 "LastModified": MagicMock(isoformat=lambda: "2026-05-20T00:00:00")},
            ],
            "IsTruncated": False,
        }
    ...
    def test_discovery_categorizes_batch(self):
        ...
        mock_response = {
            "Contents": [
                {"Key": "batch-output/batch_job_20260520.csv", "Size": 16384,
                 "LastModified": MagicMock(isoformat=lambda: "2026-05-20T00:00:00")},
            ],
            "IsTruncated": False,
        }
    ...
    def test_discovery_respects_max_files(self):
        ...
        mock_response = {
            "Contents": [
                {"Key": f"data/file_{i:03d}.csv", "Size": 1024,
                 "LastModified": MagicMock(isoformat=lambda: "2026-05-20T00:00:00")}
                for i in range(10)
            ],
            "IsTruncated": False,
