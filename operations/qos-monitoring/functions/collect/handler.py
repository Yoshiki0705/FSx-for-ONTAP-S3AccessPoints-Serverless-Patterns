...
def _demo_data(fs_id: str) -> dict[str, Any]:
    ...
    return {
        "fs_id": fs_id,
        "qos_policies": [
            {"name": "production-high", "uuid": "qp1", "max_throughput_iops": 10000, "max_throughput_mbps": 500, "min_throughput_iops": 1000, "assigned_volume_count": 3},
            {"name": "dev-low", "uuid": "qp2", "max_throughput_iops": 2000, "max_throughput_mbps": 100, "min_throughput_iops": None, "assigned_volume_count": 5},
            {"name": "default", "uuid": "qp3", "max_throughput_iops": None, "max_throughput_mbps": None, "min_throughput_iops": None, "assigned_volume_count": 2},
        ],
