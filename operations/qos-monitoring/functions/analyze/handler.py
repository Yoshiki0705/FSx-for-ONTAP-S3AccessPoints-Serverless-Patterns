...
def handler(event: dict[str, Any], context: Any) -> dict[str, Any]:
    ...
    for fs_data in file_systems:
        ...
        unlimited_policies = [p for p in policies if p.get("max_throughput_iops") is None and p.get("max_throughput_mbps") is None]
        ...
        summary = {
            ...
            "policies_with_limits": sum(1 for p in policies if p.get("max_throughput_iops") or p.get("max_throughput_mbps")),
