...
> **45+ patterns de référence** pour le traitement serverless des données NAS d'entreprise sur FSx for ONTAP via S3 Access Points — **aucune copie de données requise**.
>
> 28 cas d'usage sectoriels + 6 Operations (OPS) + 10 FlexCache/FlexClone/SnapMirror + 2 GenAI + SAP + supervision HA + événementiel + distribution Edge + File Portal UI

| | |
|---|---|
| ![Portail Amplify Gen2](solutions/amplify-portal/docs/screenshots/portal-fr-allfiles.png) | ![Nextcloud External Storage](solutions/nextcloud-test/docs/screenshots/nextcloud-files-view.png) |
| *Amplify Gen2 : navigation fichiers, traitement IA, gestion stockage, protection données* | *Nextcloud : parcourir les fichiers NAS via S3 AP* |
...
| **Utiliser** le portail (connexion, navigation, téléphone) | [Guide utilisateur](docs/fr/portal-user-guide.md) | 10 min |
...
> Ce tableau liste les contraintes. **La façon de traduire chacune en décision de conception** se trouve dans le [FSx for ONTAP Adoption Playbook](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook).
...
Détails : [S3AP Compatibility Notes](docs/s3ap-compatibility-notes.en.md) | [Compatibility Matrix (confirmée par AWS)](https://github.com/Yoshiki0705/FSx-for-ONTAP-Lakehouse-Integrations/blob/main/docs/en/compatibility-matrix.md)
...
#### Série 1 : FSx for ONTAP S3 Access Points (bibliothèque de patterns serverless)
...
#### Série 2 : FSx for ONTAP File Portal (portail de fichiers)

Sept parties. La correspondance entre article et document source se trouve dans [Série d'articles portail de fichiers (EN)](docs/devto-file-portal-series.en.md) / [JA](docs/devto-file-portal-series.md).

| Sujet | Japonais | Anglais |
|---|---|---|
| Accès depuis le navigateur | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-1-browser-access) | [dev.to](https://dev.to/aws-builders/adding-a-file-portal-to-fsx-for-ontap-s3-access-points-choosing-between-amplify-gen2-and-887) |
| Réponse aux rançongiciels et rétention WORM | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-2-ransomware-worm) | [dev.to](https://dev.to/aws-builders/embedding-storage-operations-into-a-file-portal-from-arpai-incident-response-to-regulatory-1oih) |
| Intégration d'agents IA | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-3-ai-agent-mcp) | [dev.to](https://dev.to/aws-builders/embedding-ai-agents-into-a-file-portal-from-agentcore-mcp-to-multi-agent-teams-part-3-19m1) |
| Délégation des opérations de stockage | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-4-storage-operations) | [dev.to](https://dev.to/aws-builders/putting-fsx-for-ontap-operations-on-a-file-portal-on-aws-182-actions-and-the-design-of-425g) |
| Ce que le cluster a refusé | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-5-what-only-the-cluster-tells-you) | [dev.to](https://dev.to/aws-builders/what-i-learned-driving-fsx-for-ontap-from-a-file-portal-on-aws-flexgroup-creation-capacity-3gkd) |
| Portée des fonctionnalités ONTAP | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-6-outside-the-portal) | [dev.to](https://dev.to/aws-builders/what-i-left-off-the-file-portal-on-aws-how-far-fsx-for-ontap-features-reach-and-the-work-handed-hk8) |
| Comparaison des outils de génération de projet | [Hatena](https://hakobiya.hatenablog.com/entry/fsxn-file-portal-7-nx-blocks-amplify-gen2) | [dev.to](https://dev.to/aws-builders/what-a-stack-deletion-leaves-behind-nx-plugin-for-aws-10-aws-blocks-and-amplify-gen-2-compared-10fg) |
...
| Dépôt | Résumé |
|---|---|
| [FSx-for-ONTAP-Agentic-Access-Aware-RAG](https://github.com/Yoshiki0705/FSx-for-ONTAP-Agentic-Access-Aware-RAG) | RAG agentique avec contrôle d'accès (CDK + Amazon Bedrock) |
| [FSx-for-ONTAP-Lakehouse-Integrations](https://github.com/Yoshiki0705/FSx-for-ONTAP-Lakehouse-Integrations) | Intégration Lakehouse (Databricks, Snowflake, Athena, Glue, EMR) |
| [S3-Burst-on-ONTAP-Files](https://github.com/Yoshiki0705/S3-Burst-on-ONTAP-Files) | Données collectées via l'API S3 conservées comme référence sur FSx for ONTAP et servies aux sites NFS / SMB via FlexCache (source des mesures de débit) |
