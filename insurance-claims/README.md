...
| メトリクス | 測定方法 |
|-----------|--------|
| 請求書類処理件数 / 実行 | CloudWatch Metrics / Step Functions 実行結果 |
| 損害評価精度 | CloudWatch Metrics / Step Functions 実行結果 |
| OCR + Rekognition 処理時間 | CloudWatch Metrics / Step Functions 実行結果 |
