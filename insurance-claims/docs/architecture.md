...
│                                                                              │
│  /vol/claims_data/                                                           │
│  ├── photos/claim_001/front_damage.jpg     (事故写真 — 前方損害)             │
│  ├── photos/claim_001/side_damage.png      (事故写真 — 側面損害)             │
│  ├── photos/claim_002/rear_damage.jpeg     (事故写真 — 後方損害)             │
│  ├── estimates/claim_001/repair_est.pdf    (修理見積書 PDF)                  │
│  └── estimates/claim_002/repair_est.tiff   (修理見積書 TIFF)                 │
│                                                                              │
└──────────────────────────────────┬───────────────────────────────────────────┘
                                   │
                                   ▼
...
│  │   ├── claim_001_damage.json             ← 損害評価結果                   │
│  │   └── claim_002_damage.json                                               │
│  ├── estimate-ocr/YYYY/MM/DD/                                                │
│  │   ├── claim_001_estimate.json           ← 見積書 OCR 結果               │
│  │   └── claim_002_estimate.json                                             │
│  └── reports/YYYY/MM/DD/                                                     │
│      ├── claim_001_report.json             ← 査定レポート (JSON)            │
│      └── claim_001_report.md               ← 査定レポート (人間可読)        │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
```
