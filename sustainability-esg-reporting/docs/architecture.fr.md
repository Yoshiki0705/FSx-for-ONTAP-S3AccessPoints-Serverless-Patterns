# UC23: Durabilité & ESG — Extraction de métriques / Mapping de frameworks Architecture
...
flowchart TB
    ...
    subgraph SFN["⚙️ Step Functions Workflow"]
        ...
        PROC["2️⃣ Processing Lambda(s)<br/>Textract, Bedrock"]
...
| Lambda | Compute (Discovery, Metrics Extractor, Framework Mapper, Report) |
