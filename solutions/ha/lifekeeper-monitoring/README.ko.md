...
| BedrockModelId | apac.amazon.nova-pro-v1:0 | 분석용 Bedrock 모델 |
...
- [운영](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/en/playbooks/05-operate) — 이 패턴에서 판단이 집중되는 곳
