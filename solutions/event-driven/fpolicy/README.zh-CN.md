...
- 希望检测通过 S3 访问点写入的数据（该路径上的操作不会触发 FPolicy 通知，即使使用 `mandatory` 同步策略也不会被阻止。实测 2026-08-26，ONTAP 9.18.1P3D1 — 请使用 EventBridge Scheduler 轮询或 ONTAP 原生审计日志）
...
- [性能](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/en/domains/performance) — 该模式的决策集中之处
