...
- S3 Access Point 経由で書き込まれたデータを検知したい（AP 経由の操作は FPolicy 通知を発火せず、`mandatory` 指定の同期ポリシーでも遮断されない。実測 2026-08-26 / ONTAP 9.18.1P3D1。EventBridge Scheduler のポーリングか ONTAP ネイティブ監査ログを使う）
