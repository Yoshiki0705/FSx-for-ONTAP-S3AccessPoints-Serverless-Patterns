...
class TestPublishBehavior:
    ...
    def test_non_recording_end_is_skipped(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
    ...
    def test_empty_package_is_rejected(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
        _set_env(monkeypatch, DEMO_MODE="false")
    ...
    def test_only_recording_prefix_is_ingested(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
        _set_env(monkeypatch, DEMO_MODE="false")
    ...
    def test_exceeds_lambda_ceiling_is_skipped(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
...
class TestModeration:
    ...
    def test_moderation_disabled_by_default(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
        ...
        monkeypatch.setattr(
            publish_handler.boto3,
            "client",
            lambda *a, **k: (_ for _ in ()).throw(AssertionError("rekognition should not be called")),
        )
    ...
    def test_moderation_clean_allows_publish(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
    ...
    def test_moderation_flagged_blocks_publish(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
        _set_env(monkeypatch, DEMO_MODE="false", ENABLE_MODERATION="true")
    ...
    def test_moderation_skipped_in_demo_mode(self, monkeypatch, publish_handler, lambda_context, fake_s3ap_factory):
        ...
        monkeypatch.setattr(
            publish_handler.boto3,
            "client",
            lambda *a, **k: (_ for _ in ()).throw(AssertionError("no rekognition in demo mode")),
        )
