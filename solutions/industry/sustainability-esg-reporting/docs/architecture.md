# UC23: サステナビリティ・ESG — メトリクス抽出 / フレームワークマッピング アーキテクチャ
...
flowchart TB
    ...
    subgraph SFN["⚙️ Step Functions Workflow"]
        ...
        PROC["2️⃣ Processing Lambda(s)<br/>• AI/ML サービス呼び出し<br/>• データ抽出・分析<br/>• Textract, Bedrock"]
...
| Lambda | コンピュート（Discovery, Metrics Extractor, Framework Mapper, Report） |
