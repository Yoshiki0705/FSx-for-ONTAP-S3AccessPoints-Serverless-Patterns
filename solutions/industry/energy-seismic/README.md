...
FSx for ONTAP の S3 Access Points を活用し、SEG-Y 地震探査データのメタデータ抽出、坑井ログの異常検知、コンプライアンスレポート生成を自動化するサーバーレスワークフローです。

### このパターンが適しているケース

- SEG-Y 地震探査データや坑井ログが FSx for ONTAP 上に大量に蓄積されている
...
- [設計](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/ja/playbooks/02-design) — 次に読む
