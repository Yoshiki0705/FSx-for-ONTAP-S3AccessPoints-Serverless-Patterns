...
FSx for ONTAP の S3 Access Points を活用し、事故写真の損害評価、見積書の OCR テキスト抽出、保険金請求レポートの自動生成を実現するサーバーレスワークフローです。

### このパターンが適しているケース

- 事故写真や見積書が FSx for ONTAP 上に蓄積されている
...
- [移行](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/ja/playbooks/03-migrate) — 最初に読む
- [マルチプロトコル・ID](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/ja/domains/multiprotocol-identity) — 次に読む
