...
- Utilizando FSx for ONTAP como almacenamiento de renderizado en producción de VFX / animación
...
- Cuando la calidad apruebe, PutObject en FSx for ONTAP a través de S3 AP; si no aprueba, notificación SNS
## Arquitectura
