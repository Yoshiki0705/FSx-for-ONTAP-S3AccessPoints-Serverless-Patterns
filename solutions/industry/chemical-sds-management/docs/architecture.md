# UC28: 化学・素材 — SDS 危険分類抽出 / GHS バリデーション アーキテクチャ
...
flowchart TB
    ...
    subgraph SFN["⚙️ Step Functions Workflow"]
        ...
        PROC["2️⃣ Processing Lambda(s)<br/>• AI/ML サービス呼び出し<br/>• データ抽出・分析<br/>• Textract, Rekognition, Bedrock"]
...
| Lambda | コンピュート（Discovery, SDS Extractor, Labbook Analyzer, Report） |
