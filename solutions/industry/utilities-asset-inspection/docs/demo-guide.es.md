# Energía y servicios públicos — Inspección por drones / Detección de anomalías SCADA Demo Guide
...
![Step Functions Graph View (SUCCEEDED)](../../docs/screenshots/masked/uc25-demo/step-functions-graph-view.png)
