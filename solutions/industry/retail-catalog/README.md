...
FSx for ONTAP の S3 Access Points を活用し、商品画像の自動タグ付け、カタログメタデータ生成、画像品質チェックを自動化するサーバーレスワークフローです。
...
- [コスト](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/ja/domains/cost) — このパターンで判断が集中するところ
