# UC27: 人材・HR — 履歴書スクリーニング / PII 厳格モード アーキテクチャ
...
flowchart TB
    ...
    subgraph SFN["⚙️ Step Functions Workflow"]
        ...
        PROC["2️⃣ Processing Lambda(s)<br/>• AI/ML サービス呼び出し<br/>• データ抽出・分析<br/>• Textract, Comprehend, Bedrock"]
...
| Lambda | コンピュート（Discovery, Resume Extractor, Candidate Scorer, Report） |
