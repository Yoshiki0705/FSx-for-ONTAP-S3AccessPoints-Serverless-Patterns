# UC24: Organisations à but non lucratif — Classification des demandes de subvention / Correspondance des résultats Architecture
...
| Lambda | Compute (Discovery, Grant Extractor, Outcome Matcher, Report) |
