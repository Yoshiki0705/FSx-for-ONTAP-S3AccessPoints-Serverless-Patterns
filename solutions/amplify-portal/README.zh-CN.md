...
🌐 **Language / 言語**: [日本語](README.ja.md) | [English](README.md) | [한국어](README.ko.md) | 简体中文 | [繁體中文](README.zh-TW.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [Español](README.es.md)
...
> **在其他终端上演示时**：`make portal-hosting`（从仓库根目录执行）发布到 Amplify Hosting 并生成固定的 https URL，`make portal-demo-user` 创建带角色和作用域的账户。登录必须使用 https，LAN 地址无法完成登录。操作步骤以及 `storage-admin` 可触及的不可撤销操作，请参阅[交接与支持指南](docs/portal-handover-guide.en.md)。
...
- 全文搜索设计决策（gitignored — private）
- 门户路线图 (P0-P4)（gitignored — private）
...
- [安全与治理](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/en/domains/security-governance) — 该模式的决策集中之处
