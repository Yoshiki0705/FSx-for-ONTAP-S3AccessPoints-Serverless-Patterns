...
🌐 **Language / 言語**: [日本語](README.ja.md) | English | [한국어](README.ko.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [Español](README.es.md)
...
| | Search | Semantic search across the volume |
| | Job History | Past executions (DynamoDB, owner-scoped) |
| | Analytics | Athena SQL on Glue Data Catalog |
| | Agent Directory | Stored agent definitions; run, edit or share one |
...
```
amplify-fsxns3apamplifyportal-dev1-sandbox-0123456789  ← developer 1
amplify-fsxns3apamplifyportal-dev2-sandbox-9876543210   ← developer 2
```
...
- Full-text Search Design Decision (gitignored — private)
- Portal Roadmap (P0-P4) (gitignored — private)
...
- [Security & Governance](https://github.com/Yoshiki0705/FSx-for-ONTAP-Adoption-Playbook/tree/main/docs/en/domains/security-governance) — where the decisions concentrate for this pattern
