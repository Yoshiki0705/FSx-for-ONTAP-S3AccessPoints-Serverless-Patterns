...
| リソース | 値・状況 |
|---|---|
| FSx for ONTAP ファイルシステム | `fs-0123456789abcdef0`、VPC `vpc-0ae01826f906191af`、subnet `subnet-0e36804c7fbc819a6` |
...
| `maru-win01`（172.30.1.253） | running だが `vpc-0123456789abcdef0`（172.30.x） | さらに別VPC。FSx for ONTAP に到達不可 |
