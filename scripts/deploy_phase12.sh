...
DEPLOY_BUCKET="${DEPLOY_BUCKET:-fsxn-eda-deploy-123456789012}"
...
SECRET_ARN="${SECRET_ARN:-arn:aws:secretsmanager:ap-northeast-1:123456789012:secret:fsx-ontap-fsxadmin-credentials-P9Ibbi}"
SECRET_NAME="${SECRET_NAME:-fsx-ontap-fsxadmin-credentials}"
SNS_TOPIC_ARN="${SNS_TOPIC_ARN:-arn:aws:sns:ap-northeast-1:123456789012:fsxn-s3ap-aggregated-alerts}"
