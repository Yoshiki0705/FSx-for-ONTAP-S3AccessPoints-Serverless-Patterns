...
LANG_LABELS = {
    "ko": {
        "core": "핵심 메시지",
        "duration": "예상 시간",
        "footer": "*본 문서는 기술 프레젠테이션용 데모 영상 제작 가이드입니다.*",
    },
    ...
    "fr": {
        ...
        "footer": "*Ce document sert de guide de production pour les vidéos de démonstration technique.*",
    },
    "de": {
        "core": "Kernbotschaft",
        "duration": "Voraussichtliche Dauer",
        "footer": "*Dieses Dokument dient als Produktionsleitfaden für technische Demonstrationsvideos.*",
    },
    "es": {
        "core": "Mensaje clave",
        "duration": "Duración prevista",
        "footer": "*Este documento sirve como guía de producción para videos de demostración técnica.*",
    },
}
