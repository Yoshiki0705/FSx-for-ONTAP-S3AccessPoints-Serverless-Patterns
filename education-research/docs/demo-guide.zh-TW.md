...
![UC13 Step Functions 圖表視圖 (SUCCEEDED)](../../docs/screenshots/masked/uc13-demo/step-functions-graph-succeeded.png)

![UC13 Step Functions 圖表 (整體概覽)](../../docs/screenshots/masked/uc13-demo/step-functions-graph-overview.png)

![UC13 Step Functions 圖表 (縮放 — 各步驟詳細)](../../docs/screenshots/masked/uc13-demo/step-functions-graph-zoomed.png)
