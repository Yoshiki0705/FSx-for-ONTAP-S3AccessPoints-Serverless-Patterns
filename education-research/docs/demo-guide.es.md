...
![UC13 Vista de gráfico Step Functions (SUCCEEDED)](../../docs/screenshots/masked/uc13-demo/step-functions-graph-succeeded.png)

![UC13 Gráfico Step Functions (vista general)](../../docs/screenshots/masked/uc13-demo/step-functions-graph-overview.png)

![UC13 Gráfico Step Functions (ampliado — detalle por paso)](../../docs/screenshots/masked/uc13-demo/step-functions-graph-zoomed.png)
