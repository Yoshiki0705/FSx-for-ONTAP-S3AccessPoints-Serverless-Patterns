...
flowchart TB
    ...
    subgraph SFN["⚙️ Step Functions Workflow"]
        ...
        PROC["2️⃣ Processing Lambda(s)<br/>• AI/ML サービス呼び出し<br/>• データ抽出・分析<br/>• Rekognition, Textract, Comprehend, Bedrock"]
...
4. **Cross-Region 対応** — Textract は us-east-1 で呼び出し
...
| Lambda | コンピュート（Discovery, Property Analyzer, Contract Extractor, Report） |
| Amazon Rekognition | AI/ML 処理 |
| Amazon Textract | AI/ML 処理 |
| Amazon Comprehend | AI/ML 処理 |
