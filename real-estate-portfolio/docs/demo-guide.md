...
| 項目 | 詳細 |
|------|------|
| **役職** | 不動産投資法人 アセットマネージャー / 物件管理担当 |
| **日常業務** | 物件情報管理、契約書レビュー、ポートフォリオ分析 |
| **課題** | 大量の物件画像と契約書の手動処理、市場動向との照合 |
| **期待する成果** | 物件画像の自動評価と契約書データの構造化抽出 |
...
cd fsxn-s3ap-serverless-patterns/real-estate-portfolio
```
