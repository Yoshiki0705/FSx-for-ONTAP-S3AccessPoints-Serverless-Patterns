...
> Hereafter, FSx for ONTAP S3 Access Points is abbreviated as **S3 AP**.
...
- **Polling-based architecture**: EventBridge Scheduler + Step Functions (S3 AP does not support `GetBucketNotificationConfiguration`)
