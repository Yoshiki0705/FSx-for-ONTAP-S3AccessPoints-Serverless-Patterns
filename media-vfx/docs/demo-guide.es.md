...
![UC4 Vista de gráfico Step Functions (SUCCEEDED)](../../docs/screenshots/masked/uc4-demo/step-functions-graph-succeeded.png)

![UC4 Gráfico Step Functions (ampliado — detalle por paso)](../../docs/screenshots/masked/uc4-demo/step-functions-graph-zoomed.png)

### Pantallas UI/UX objetivo para re-verificación (lista de capturas recomendadas)

- (A definir durante la re-verificación)
