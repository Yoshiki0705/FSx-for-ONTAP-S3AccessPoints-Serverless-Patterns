...
│                                                                              │
│  /vol/vfx_projects/                                                          │
│  ├── shots/SH010/comp_v003.exr       (OpenEXR コンポジット)                  │
│  ├── shots/SH010/plate_v001.dpx      (DPX プレート)                          │
│  ├── shots/SH020/anim_v002.mov       (QuickTime プレビュー)                  │
│  └── assets/character_rig.abc        (Alembic キャッシュ)                    │
│                                                                              │
└──────────────────────────────────┬───────────────────────────────────────────┘
                                   │
                                   ▼
...
│  • ListObjectsV2 (VFX アセット検出)                                          │
│  • GetObject (EXR/DPX/MOV/ABC 取得)                                          │
│  • PutObject (品質合格アセット書き戻し)                                      │
│                                                                              │
└──────────────────────────────────┬───────────────────────────────────────────┘
                                   │
                                   ▼
...
│  │  • S3 AP List│    │  • Deadline Cloud    │    │  • アーティファ│          │
│  │  • EXR/DPX等 │    │    ジョブ投入        │    │    クト検出    │          │
│  └─────────────┘    └──────────────────────┘    └───────┬────────┘          │
│                                                          │                   │
│                                                          ▼                   │
...
│                         Output                                                │
│                                                                              │
│  【合格時】S3 AP PutObject → FSx ONTAP に書き戻し                           │
│  /vol/vfx_approved/                                                          │
│  └── shots/SH010/comp_v003_approved.exr                                      │
│                                                                              │
│  【不合格時】SNS 通知 → アーティスト再レンダリング                           │
│  • アーティファクト種別、検出位置、信頼度スコア                              │
│                                                                              │
└──────────────────────────────────────────────────────────────────────────────┘
```
